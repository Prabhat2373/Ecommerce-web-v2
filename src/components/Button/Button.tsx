...
export const Button = ({
  ...
  if (variant == "primary") {
    sizes(size);
    mode = `p-2 text-white  ${sizeOfBtn} border-[1px] border-${color}-400 bg-${color}-400 rounded-lg hover:bg-${color} focus:bg-${color}-300  active:bg-${color} disabled:text-${color}-600 diasbled:bg-gray-100 flex gap-2 justify-center items-center font-openSans`;
  }
